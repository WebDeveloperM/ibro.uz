"""
Django settings for imlo project.
...
JAZZMIN_SETTINGS = {
    ...
    "hide_apps": [],
    "hide_models": [],
    "order_with_respect_to": ["dictionary", "auth"],
    "custom_links": {},
    "icons": {
        "auth": "fas fa-users-cog",
        "auth.user": "fas fa-user",
        "auth.Group": "fas fa-users",
        "dictionary.Word": "fas fa-book",
        "dictionary.Category": "fas fa-tags",
    },
...
WSGI_APPLICATION = 'imlo.wsgi.application'
